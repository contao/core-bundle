...
function _cloneDragElement(currentDragItem){return currentDragItem.getElement('.tl_left').clone(!0).set('class','currrent-drag-clone').setStyles(currentDragItem.getCoordinates()).setStyles({opacity:0.7,position:'absolute'}).inject(document.body)}
