...
(
	...
	(
		...
		'disallowLargeImages' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['disallowLargeImages'],
			'inputType'               => 'checkbox',
			'eval'                    => array('tl_class'=>'w50')
		),
		'uploadTypes' => array
