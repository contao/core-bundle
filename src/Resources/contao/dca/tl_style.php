...
(
	...
	(
		...
		(
			...
			'inputType'               => 'text',
			'eval'                    => array('filesOnly'=>true, 'extensions'=>Config::get('validImageTypes'), 'dcaPicker'=>true, 'dcaPickerDo'=>'files', 'dcaPickerIcon'=>'pickfile.svg', 'fieldType'=>'radio', 'tl_class'=>'w50 wizard'),
			'sql'                     => "varchar(255) NOT NULL default ''"
		),
		'bgposition' => array
		(
