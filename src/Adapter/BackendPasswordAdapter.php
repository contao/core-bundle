...
class BackendPasswordAdapter implements BackendPasswordAdapterInterface
{
    ...
    {
        return \Contao\BackendPassword::getTheme();
    }
    ...
    {
        return \Contao\BackendPassword::getThemes();
    }
    ...
    {
        return \Contao\BackendPassword::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendPassword::getAceType($type);
    }
    ...
    {
        return \Contao\BackendPassword::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendPassword::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendPassword::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendPassword::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendPassword::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendPassword::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendPassword::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendPassword::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendPassword::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPassword::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendPassword::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPassword::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPassword::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendPassword::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendPassword::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendPassword::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendPassword::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendPassword::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendPassword::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendPassword::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendPassword::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendPassword::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendPassword::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendPassword::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendPassword::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendPassword::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendPassword::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendPassword::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendPassword::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendPassword::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendPassword::getPageSections();
    }
    ...
    {
        return \Contao\BackendPassword::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendPassword::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendPassword::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendPassword::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendPassword::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendPassword::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendPassword::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendPassword::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendPassword::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendPassword::getCountries();
    }
    ...
    {
        return \Contao\BackendPassword::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendPassword::getTimeZones();
    }
    ...
    {
        return \Contao\BackendPassword::getImageSizes();
    }
    ...
    {
        return \Contao\BackendPassword::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendPassword::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendPassword::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendPassword::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendPassword::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendPassword::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendPassword::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendPassword::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendPassword::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendPassword::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendPassword::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendPassword::enableModule($strName);
    }
    ...
    {
        \Contao\BackendPassword::disableModule($strName);
    }
}
