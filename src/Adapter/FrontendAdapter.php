...
class FrontendAdapter implements FrontendAdapterInterface
{
    ...
    {
        return \Contao\Frontend::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\Frontend::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\Frontend::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\Frontend::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\Frontend::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\Frontend::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\Frontend::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\Frontend::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\Frontend::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\Frontend::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\Frontend::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\Frontend::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\Frontend::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\Frontend::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\Frontend::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\Frontend::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\Frontend::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\Frontend::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\Frontend::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\Frontend::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\Frontend::getTheme();
    }
    ...
    {
        return \Contao\Frontend::getBackendThemes();
    }
    ...
    {
        return \Contao\Frontend::getPageDetails($intId);
    }
    ...
    {
        return \Contao\Frontend::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\Frontend::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\Frontend::getPageSections();
    }
    ...
    {
        return \Contao\Frontend::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\Frontend::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\Frontend::findContentElement($strName);
    }
    ...
    {
        return \Contao\Frontend::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\Frontend::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\Frontend::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\Frontend::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\Frontend::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\Frontend::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\Frontend::getCountries();
    }
    ...
    {
        return \Contao\Frontend::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\Frontend::getTimeZones();
    }
    ...
    {
        return \Contao\Frontend::getImageSizes();
    }
    ...
    {
        return \Contao\Frontend::urlEncode($strPath);
    }
    ...
    {
        \Contao\Frontend::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\Frontend::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\Frontend::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\Frontend::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\Frontend::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\Frontend::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\Frontend::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\Frontend::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\Frontend::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\Frontend::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\Frontend::enableModule($strName);
    }
    ...
    {
        \Contao\Frontend::disableModule($strName);
    }
}
