...
class FrontendCronAdapter implements FrontendCronAdapterInterface
{
    ...
    {
        return \Contao\FrontendCron::getPageIdFromUrl();
    }
    ...
    {
        return \Contao\FrontendCron::getRootIdFromUrl();
    }
    ...
    {
        return \Contao\FrontendCron::getRootPageFromUrl();
    }
    ...
    {
        return \Contao\FrontendCron::addToUrl($strRequest, $blnIgnoreParams, $arrUnset);
    }
    ...
    {
        return \Contao\FrontendCron::getMetaData($strData, $strLanguage);
    }
    ...
    {
        return \Contao\FrontendCron::getCronTimeout();
    }
    ...
    {
        \Contao\FrontendCron::indexPageIfApplicable($objResponse);
    }
    ...
    {
        return \Contao\FrontendCron::getResponseFromCache();
    }
    ...
    {
        return \Contao\FrontendCron::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\FrontendCron::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\FrontendCron::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\FrontendCron::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\FrontendCron::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\FrontendCron::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\FrontendCron::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\FrontendCron::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\FrontendCron::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\FrontendCron::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\FrontendCron::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\FrontendCron::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\FrontendCron::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\FrontendCron::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\FrontendCron::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\FrontendCron::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\FrontendCron::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\FrontendCron::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\FrontendCron::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\FrontendCron::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\FrontendCron::getTheme();
    }
    ...
    {
        return \Contao\FrontendCron::getBackendThemes();
    }
    ...
    {
        return \Contao\FrontendCron::getPageDetails($intId);
    }
    ...
    {
        return \Contao\FrontendCron::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\FrontendCron::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\FrontendCron::getPageSections();
    }
    ...
    {
        return \Contao\FrontendCron::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\FrontendCron::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\FrontendCron::findContentElement($strName);
    }
    ...
    {
        return \Contao\FrontendCron::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\FrontendCron::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\FrontendCron::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\FrontendCron::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\FrontendCron::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\FrontendCron::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\FrontendCron::getCountries();
    }
    ...
    {
        return \Contao\FrontendCron::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\FrontendCron::getTimeZones();
    }
    ...
    {
        return \Contao\FrontendCron::getImageSizes();
    }
    ...
    {
        return \Contao\FrontendCron::urlEncode($strPath);
    }
    ...
    {
        \Contao\FrontendCron::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\FrontendCron::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\FrontendCron::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\FrontendCron::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\FrontendCron::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\FrontendCron::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\FrontendCron::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\FrontendCron::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\FrontendCron::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\FrontendCron::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\FrontendCron::enableModule($strName);
    }
    ...
    {
        \Contao\FrontendCron::disableModule($strName);
    }
}
