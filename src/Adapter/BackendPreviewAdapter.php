...
/**
 * Provides an adapter for the Contao BackendPreview class.
 *
 * @author Yanick Witschi <https://github.com/toflar>
 */
class BackendPreviewAdapter implements BackendPreviewAdapterInterface
{
    /**
    ...
    public function run()
    {
        $instance = new \Contao\BackendPreview();
        return $instance->run();
    }
    ...
    {
        return \Contao\BackendPreview::getTheme();
    }
    ...
    {
        return \Contao\BackendPreview::getThemes();
    }
    ...
    {
        return \Contao\BackendPreview::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendPreview::getAceType($type);
    }
    ...
    {
        return \Contao\BackendPreview::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendPreview::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendPreview::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendPreview::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendPreview::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendPreview::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendPreview::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendPreview::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendPreview::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPreview::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendPreview::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPreview::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPreview::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendPreview::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendPreview::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendPreview::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendPreview::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendPreview::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendPreview::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendPreview::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendPreview::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendPreview::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendPreview::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendPreview::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendPreview::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendPreview::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendPreview::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendPreview::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendPreview::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendPreview::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendPreview::getPageSections();
    }
    ...
    {
        return \Contao\BackendPreview::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendPreview::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendPreview::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendPreview::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendPreview::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendPreview::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendPreview::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendPreview::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendPreview::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendPreview::getCountries();
    }
    ...
    {
        return \Contao\BackendPreview::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendPreview::getTimeZones();
    }
    ...
    {
        return \Contao\BackendPreview::getImageSizes();
    }
    ...
    {
        return \Contao\BackendPreview::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendPreview::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendPreview::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendPreview::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendPreview::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendPreview::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendPreview::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendPreview::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendPreview::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendPreview::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendPreview::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendPreview::enableModule($strName);
    }
    ...
    {
        \Contao\BackendPreview::disableModule($strName);
    }
}
