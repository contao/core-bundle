...
/**
 * Provides an adapter for the Contao BackendHelp class.
 *
 * @author Yanick Witschi <https://github.com/toflar>
 */
class BackendHelpAdapter implements BackendHelpAdapterInterface
{
    /**
    ...
    public function run()
    {
        $instance = new \Contao\BackendHelp();
        return $instance->run();
    }
    ...
    {
        return \Contao\BackendHelp::getTheme();
    }
    ...
    {
        return \Contao\BackendHelp::getThemes();
    }
    ...
    {
        return \Contao\BackendHelp::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendHelp::getAceType($type);
    }
    ...
    {
        return \Contao\BackendHelp::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendHelp::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendHelp::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendHelp::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendHelp::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendHelp::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendHelp::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendHelp::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendHelp::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendHelp::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendHelp::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendHelp::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendHelp::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendHelp::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendHelp::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendHelp::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendHelp::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendHelp::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendHelp::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendHelp::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendHelp::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendHelp::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendHelp::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendHelp::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendHelp::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendHelp::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendHelp::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendHelp::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendHelp::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendHelp::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendHelp::getPageSections();
    }
    ...
    {
        return \Contao\BackendHelp::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendHelp::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendHelp::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendHelp::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendHelp::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendHelp::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendHelp::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendHelp::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendHelp::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendHelp::getCountries();
    }
    ...
    {
        return \Contao\BackendHelp::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendHelp::getTimeZones();
    }
    ...
    {
        return \Contao\BackendHelp::getImageSizes();
    }
    ...
    {
        return \Contao\BackendHelp::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendHelp::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendHelp::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendHelp::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendHelp::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendHelp::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendHelp::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendHelp::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendHelp::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendHelp::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendHelp::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendHelp::enableModule($strName);
    }
    ...
    {
        \Contao\BackendHelp::disableModule($strName);
    }
}
