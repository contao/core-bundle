...
class BackendIndexAdapter implements BackendIndexAdapterInterface
{
    ...
    {
        return \Contao\BackendIndex::getTheme();
    }
    ...
    {
        return \Contao\BackendIndex::getThemes();
    }
    ...
    {
        return \Contao\BackendIndex::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendIndex::getAceType($type);
    }
    ...
    {
        return \Contao\BackendIndex::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendIndex::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendIndex::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendIndex::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendIndex::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendIndex::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendIndex::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendIndex::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendIndex::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendIndex::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendIndex::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendIndex::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendIndex::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendIndex::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendIndex::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendIndex::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendIndex::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendIndex::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendIndex::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendIndex::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendIndex::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendIndex::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendIndex::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendIndex::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendIndex::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendIndex::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendIndex::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendIndex::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendIndex::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendIndex::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendIndex::getPageSections();
    }
    ...
    {
        return \Contao\BackendIndex::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendIndex::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendIndex::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendIndex::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendIndex::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendIndex::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendIndex::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendIndex::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendIndex::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendIndex::getCountries();
    }
    ...
    {
        return \Contao\BackendIndex::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendIndex::getTimeZones();
    }
    ...
    {
        return \Contao\BackendIndex::getImageSizes();
    }
    ...
    {
        return \Contao\BackendIndex::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendIndex::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendIndex::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendIndex::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendIndex::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendIndex::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendIndex::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendIndex::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendIndex::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendIndex::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendIndex::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendIndex::enableModule($strName);
    }
    ...
    {
        \Contao\BackendIndex::disableModule($strName);
    }
}
