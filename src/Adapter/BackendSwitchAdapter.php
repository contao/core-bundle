...
class BackendSwitchAdapter implements BackendSwitchAdapterInterface
{
    ...
    {
        return \Contao\BackendSwitch::getTheme();
    }
    ...
    {
        return \Contao\BackendSwitch::getThemes();
    }
    ...
    {
        return \Contao\BackendSwitch::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendSwitch::getAceType($type);
    }
    ...
    {
        return \Contao\BackendSwitch::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendSwitch::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendSwitch::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendSwitch::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendSwitch::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendSwitch::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendSwitch::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendSwitch::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendSwitch::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendSwitch::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendSwitch::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendSwitch::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendSwitch::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendSwitch::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendSwitch::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendSwitch::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendSwitch::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendSwitch::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendSwitch::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendSwitch::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendSwitch::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendSwitch::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendSwitch::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendSwitch::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendSwitch::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendSwitch::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendSwitch::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendSwitch::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendSwitch::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendSwitch::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendSwitch::getPageSections();
    }
    ...
    {
        return \Contao\BackendSwitch::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendSwitch::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendSwitch::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendSwitch::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendSwitch::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendSwitch::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendSwitch::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendSwitch::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendSwitch::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendSwitch::getCountries();
    }
    ...
    {
        return \Contao\BackendSwitch::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendSwitch::getTimeZones();
    }
    ...
    {
        return \Contao\BackendSwitch::getImageSizes();
    }
    ...
    {
        return \Contao\BackendSwitch::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendSwitch::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendSwitch::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendSwitch::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendSwitch::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendSwitch::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendSwitch::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendSwitch::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendSwitch::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendSwitch::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendSwitch::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendSwitch::enableModule($strName);
    }
    ...
    {
        \Contao\BackendSwitch::disableModule($strName);
    }
}
