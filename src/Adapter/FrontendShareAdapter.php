...
class FrontendShareAdapter implements FrontendShareAdapterInterface
{
    ...
    {
        return \Contao\FrontendShare::getPageIdFromUrl();
    }
    ...
    {
        return \Contao\FrontendShare::getRootIdFromUrl();
    }
    ...
    {
        return \Contao\FrontendShare::getRootPageFromUrl();
    }
    ...
    {
        return \Contao\FrontendShare::addToUrl($strRequest, $blnIgnoreParams, $arrUnset);
    }
    ...
    {
        return \Contao\FrontendShare::getMetaData($strData, $strLanguage);
    }
    ...
    {
        return \Contao\FrontendShare::getCronTimeout();
    }
    ...
    {
        \Contao\FrontendShare::indexPageIfApplicable($objResponse);
    }
    ...
    {
        return \Contao\FrontendShare::getResponseFromCache();
    }
    ...
    {
        return \Contao\FrontendShare::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\FrontendShare::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\FrontendShare::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\FrontendShare::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\FrontendShare::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\FrontendShare::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\FrontendShare::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\FrontendShare::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\FrontendShare::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\FrontendShare::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\FrontendShare::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\FrontendShare::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\FrontendShare::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\FrontendShare::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\FrontendShare::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\FrontendShare::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\FrontendShare::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\FrontendShare::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\FrontendShare::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\FrontendShare::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\FrontendShare::getTheme();
    }
    ...
    {
        return \Contao\FrontendShare::getBackendThemes();
    }
    ...
    {
        return \Contao\FrontendShare::getPageDetails($intId);
    }
    ...
    {
        return \Contao\FrontendShare::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\FrontendShare::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\FrontendShare::getPageSections();
    }
    ...
    {
        return \Contao\FrontendShare::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\FrontendShare::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\FrontendShare::findContentElement($strName);
    }
    ...
    {
        return \Contao\FrontendShare::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\FrontendShare::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\FrontendShare::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\FrontendShare::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\FrontendShare::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\FrontendShare::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\FrontendShare::getCountries();
    }
    ...
    {
        return \Contao\FrontendShare::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\FrontendShare::getTimeZones();
    }
    ...
    {
        return \Contao\FrontendShare::getImageSizes();
    }
    ...
    {
        return \Contao\FrontendShare::urlEncode($strPath);
    }
    ...
    {
        \Contao\FrontendShare::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\FrontendShare::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\FrontendShare::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\FrontendShare::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\FrontendShare::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\FrontendShare::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\FrontendShare::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\FrontendShare::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\FrontendShare::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\FrontendShare::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\FrontendShare::enableModule($strName);
    }
    ...
    {
        \Contao\FrontendShare::disableModule($strName);
    }
}
