...
class BackendFileAdapter implements BackendFileAdapterInterface
{
    ...
    {
        return \Contao\BackendFile::getTheme();
    }
    ...
    {
        return \Contao\BackendFile::getThemes();
    }
    ...
    {
        return \Contao\BackendFile::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendFile::getAceType($type);
    }
    ...
    {
        return \Contao\BackendFile::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendFile::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendFile::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendFile::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendFile::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendFile::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendFile::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendFile::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendFile::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendFile::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendFile::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendFile::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendFile::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendFile::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendFile::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendFile::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendFile::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendFile::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendFile::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendFile::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendFile::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendFile::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendFile::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendFile::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendFile::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendFile::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendFile::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendFile::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendFile::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendFile::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendFile::getPageSections();
    }
    ...
    {
        return \Contao\BackendFile::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendFile::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendFile::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendFile::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendFile::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendFile::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendFile::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendFile::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendFile::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendFile::getCountries();
    }
    ...
    {
        return \Contao\BackendFile::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendFile::getTimeZones();
    }
    ...
    {
        return \Contao\BackendFile::getImageSizes();
    }
    ...
    {
        return \Contao\BackendFile::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendFile::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendFile::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendFile::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendFile::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendFile::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendFile::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendFile::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendFile::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendFile::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendFile::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendFile::enableModule($strName);
    }
    ...
    {
        \Contao\BackendFile::disableModule($strName);
    }
}
