...
class BackendMainAdapter implements BackendMainAdapterInterface
{
    ...
    {
        return \Contao\BackendMain::getTheme();
    }
    ...
    {
        return \Contao\BackendMain::getThemes();
    }
    ...
    {
        return \Contao\BackendMain::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendMain::getAceType($type);
    }
    ...
    {
        return \Contao\BackendMain::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendMain::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendMain::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendMain::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendMain::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendMain::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendMain::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendMain::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendMain::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendMain::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendMain::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendMain::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendMain::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendMain::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendMain::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendMain::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendMain::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendMain::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendMain::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendMain::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendMain::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendMain::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendMain::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendMain::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendMain::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendMain::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendMain::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendMain::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendMain::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendMain::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendMain::getPageSections();
    }
    ...
    {
        return \Contao\BackendMain::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendMain::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendMain::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendMain::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendMain::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendMain::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendMain::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendMain::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendMain::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendMain::getCountries();
    }
    ...
    {
        return \Contao\BackendMain::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendMain::getTimeZones();
    }
    ...
    {
        return \Contao\BackendMain::getImageSizes();
    }
    ...
    {
        return \Contao\BackendMain::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendMain::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendMain::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendMain::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendMain::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendMain::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendMain::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendMain::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendMain::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendMain::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendMain::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendMain::enableModule($strName);
    }
    ...
    {
        \Contao\BackendMain::disableModule($strName);
    }
}
