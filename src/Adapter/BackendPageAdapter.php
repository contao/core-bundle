...
/**
 * Provides an adapter for the Contao BackendPage class.
 *
 * @author Yanick Witschi <https://github.com/toflar>
 */
class BackendPageAdapter implements BackendPageAdapterInterface
{
    /**
    ...
    public function run()
    {
        $instance = new \Contao\BackendPage();
        return $instance->run();
    }
    ...
    {
        return \Contao\BackendPage::getTheme();
    }
    ...
    {
        return \Contao\BackendPage::getThemes();
    }
    ...
    {
        return \Contao\BackendPage::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendPage::getAceType($type);
    }
    ...
    {
        return \Contao\BackendPage::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendPage::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendPage::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendPage::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendPage::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendPage::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendPage::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendPage::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendPage::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPage::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendPage::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPage::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendPage::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendPage::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendPage::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendPage::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendPage::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendPage::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendPage::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendPage::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendPage::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendPage::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendPage::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendPage::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendPage::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendPage::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendPage::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendPage::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendPage::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendPage::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendPage::getPageSections();
    }
    ...
    {
        return \Contao\BackendPage::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendPage::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendPage::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendPage::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendPage::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendPage::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendPage::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendPage::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendPage::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendPage::getCountries();
    }
    ...
    {
        return \Contao\BackendPage::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendPage::getTimeZones();
    }
    ...
    {
        return \Contao\BackendPage::getImageSizes();
    }
    ...
    {
        return \Contao\BackendPage::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendPage::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendPage::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendPage::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendPage::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendPage::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendPage::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendPage::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendPage::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendPage::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendPage::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendPage::enableModule($strName);
    }
    ...
    {
        \Contao\BackendPage::disableModule($strName);
    }
}
