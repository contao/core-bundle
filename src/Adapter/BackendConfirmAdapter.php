...
class BackendConfirmAdapter implements BackendConfirmAdapterInterface
{
    ...
    {
        return \Contao\BackendConfirm::getTheme();
    }
    ...
    {
        return \Contao\BackendConfirm::getThemes();
    }
    ...
    {
        return \Contao\BackendConfirm::getTinyMceLanguage();
    }
    ...
    {
        return \Contao\BackendConfirm::getAceType($type);
    }
    ...
    {
        return \Contao\BackendConfirm::getTinyTemplates();
    }
    ...
    {
        return \Contao\BackendConfirm::addToUrl($strRequest, $blnAddRef, $arrUnset);
    }
    ...
    {
        return \Contao\BackendConfirm::findSearchablePages($pid, $domain, $blnIsSitemap, $strLanguage);
    }
    ...
    {
        \Contao\BackendConfirm::addPagesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendConfirm::addPageIcon($row, $label, $dc, $imageAttribute, $blnReturnImage, $blnProtected);
    }
    ...
    {
        \Contao\BackendConfirm::addFilesBreadcrumb($strKey);
    }
    ...
    {
        return \Contao\BackendConfirm::getTemplate($strTemplate, $strFormat);
    }
    ...
    {
        return \Contao\BackendConfirm::getTemplateGroup($strPrefix);
    }
    ...
    {
        return \Contao\BackendConfirm::getFrontendModule($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendConfirm::getArticle($varId, $blnMultiMode, $blnIsInsertTag, $strColumn);
    }
    ...
    {
        return \Contao\BackendConfirm::getContentElement($intId, $strColumn);
    }
    ...
    {
        return \Contao\BackendConfirm::getForm($varId, $strColumn);
    }
    ...
    {
        return \Contao\BackendConfirm::getPageStatusIcon($objPage);
    }
    ...
    {
        return \Contao\BackendConfirm::isVisibleElement($objElement);
    }
    ...
    {
        return \Contao\BackendConfirm::replaceInsertTags($strBuffer, $blnCache);
    }
    ...
    {
        return \Contao\BackendConfirm::replaceDynamicScriptTags($strBuffer);
    }
    ...
    {
        return \Contao\BackendConfirm::generateMargin($arrValues, $strType);
    }
    ...
    {
        \Contao\BackendConfirm::redirect($strLocation, $intStatus);
    }
    ...
    {
        return \Contao\BackendConfirm::generateFrontendUrl($arrRow, $strParams, $strForceLang, $blnFixDomain);
    }
    ...
    {
        return \Contao\BackendConfirm::convertRelativeUrls($strContent, $strBase, $blnHrefOnly);
    }
    ...
    {
        \Contao\BackendConfirm::sendFileToBrowser($strFile);
    }
    ...
    {
        \Contao\BackendConfirm::loadDataContainer($strTable, $blnNoCache);
    }
    ...
    {
        \Contao\BackendConfirm::addImageToTemplate($objTemplate, $arrItem, $intMaxWidth, $strLightboxId);
    }
    ...
    {
        \Contao\BackendConfirm::addEnclosuresToTemplate($objTemplate, $arrItem, $strKey);
    }
    ...
    {
        \Contao\BackendConfirm::setStaticUrls($objPage);
    }
    ...
    {
        return \Contao\BackendConfirm::addStaticUrlTo($script);
    }
    ...
    {
        return \Contao\BackendConfirm::getBackendThemes();
    }
    ...
    {
        return \Contao\BackendConfirm::getPageDetails($intId);
    }
    ...
    {
        return \Contao\BackendConfirm::restoreBasicEntities($strBuffer);
    }
    ...
    {
        return \Contao\BackendConfirm::generateImage($src, $alt, $attributes);
    }
    ...
    {
        return \Contao\BackendConfirm::getPageSections();
    }
    ...
    {
        return \Contao\BackendConfirm::optionSelected($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendConfirm::optionChecked($strOption, $varValues);
    }
    ...
    {
        return \Contao\BackendConfirm::findContentElement($strName);
    }
    ...
    {
        return \Contao\BackendConfirm::findFrontendModule($strName);
    }
    ...
    {
        return \Contao\BackendConfirm::importStatic($strClass, $strKey, $blnForce);
    }
    ...
    {
        \Contao\BackendConfirm::log($strText, $strFunction, $strCategory);
    }
    ...
    {
        return \Contao\BackendConfirm::getReferer($blnEncodeAmpersands, $strTable);
    }
    ...
    {
        \Contao\BackendConfirm::loadLanguageFile($strName, $strLanguage, $blnNoCache);
    }
    ...
    {
        return \Contao\BackendConfirm::isInstalledLanguage($strLanguage);
    }
    ...
    {
        return \Contao\BackendConfirm::getCountries();
    }
    ...
    {
        return \Contao\BackendConfirm::getLanguages($blnInstalledOnly);
    }
    ...
    {
        return \Contao\BackendConfirm::getTimeZones();
    }
    ...
    {
        return \Contao\BackendConfirm::getImageSizes();
    }
    ...
    {
        return \Contao\BackendConfirm::urlEncode($strPath);
    }
    ...
    {
        \Contao\BackendConfirm::setCookie($strName, $varValue, $intExpires, $strPath, $strDomain, $blnSecure, $blnHttpOnly);
    }
    ...
    {
        return \Contao\BackendConfirm::getReadableSize($intSize, $intDecimals);
    }
    ...
    {
        return \Contao\BackendConfirm::getFormattedNumber($varNumber, $intDecimals);
    }
    ...
    {
        return \Contao\BackendConfirm::getSessionHash($strCookie);
    }
    ...
    {
        return \Contao\BackendConfirm::anonymizeIp($strIp);
    }
    ...
    {
        return \Contao\BackendConfirm::convertXlfToPhp($strName, $strLanguage, $blnLoad);
    }
    ...
    {
        return \Contao\BackendConfirm::parseDate($strFormat, $intTstamp);
    }
    ...
    {
        return \Contao\BackendConfirm::splitFriendlyName($strEmail);
    }
    ...
    {
        return \Contao\BackendConfirm::getIndexFreeRequest($blnAmpersand);
    }
    ...
    {
        return \Contao\BackendConfirm::getModelClassFromTable($strTable);
    }
    ...
    {
        \Contao\BackendConfirm::enableModule($strName);
    }
    ...
    {
        \Contao\BackendConfirm::disableModule($strName);
    }
}
