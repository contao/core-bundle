...
use Contao\CoreBundle\EventListener\Hook\OutputFrontendTemplateListener;
use Contao\CoreBundle\Test\TestCase;
use Contao\FrontendTemplate;

/**
 * Tests the OutputFrontendTemplateListener class.
 *
 * @author Leo Feyer <https:/github.com/leofeyer>
 */
class OutputFrontendTemplateListenerTest extends TestCase
{
    /**
     * @var OutputFrontendTemplateListener
     */
    private $listener;
    ...
    protected function setUp()
    {
        ...
        $this->listener = new OutputFrontendTemplateListener();
    }
    ...
    {
        $this->assertInstanceOf('Contao\\CoreBundle\\EventListener\\Hook\\OutputFrontendTemplateListener', $this->listener);
    }
    ...
    public function TestOnOutputFrontendTemplate()
    {
        ...
        $GLOBALS['TL_HOOKS']['outputFrontendTemplate'][] = function ($buffer) {
            return $buffer;
        };

        $this->listener->onOutputFrontendTemplate($event);
