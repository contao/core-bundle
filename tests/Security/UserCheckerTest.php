...
class UserCheckerTest extends TestCase
{
    ...
    {
        $this->setGlobals('Y-m-d', 300, '127.0.0.1', 80, 'mail@example.org');
    ...
    /**
     * Sets some global variables (S_SERVER and $GLOBALS).
     *
     ...
     */
    private function setGlobals(string $dateFormat = null, int $lockPeriod = null, string $serverName = null, int $serverPort = null, string $adminEmail = null): void
    {
        if (null !== $dateFormat) {
    ...
    /**
     * Get the MSC.lockedAccount.1 string with replaced arguments.
     *
     * @param array $arguments
     *
     * @return string
     */
    private function getLockedAccountMessage(array $arguments): string
    {
        return <<<EOT
The following Contao account has been locked for security reasons.

Username: $arguments[0]
Real name: $arguments[1]
Website: $arguments[2]

The account has been locked for $arguments[3] minutes, because the user has entered an invalid password three times in a row. After this period of time, the account will be unlocked automatically.
