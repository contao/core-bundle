 ...
 */
class IndexFreeEnvironmentTest extends TestCase
{
    /**
     * {@inheritdoc}
     */
    ...
    public function testApache()
    {
        ...
        $_SERVER = [
            ...
            'SCRIPT_NAME' => '/core/en/academy.html',
            'PHP_SELF' => '/core/en/academy.html',
        ];
    ...
    public function testCgiFcgi()
    {
        ...
        $_SERVER = [
            ...
            'ORIG_PATH_INFO' => '/core/en/academy.html',
            'ORIG_PATH_TRANSLATED' => $this->getRootDir() . '/core/en/academy.html',
    ...
    protected function runTests()
    {
        ...
        $this->assertEquals('/core/en/academy.html', Environment::get('scriptName'));
