...
/**
 * Allows to export and import themes
 *
...
<div class="tl_submit_container">
  <input type="submit" name="save" id="save" class="tl_submit" accesskey="s" value="'.specialchars($GLOBALS['TL_LANG']['tl_theme']['importTheme'][0]).'">
	...
	/**
	 * Compare the theme files
	 *
	 * Compares the theme tables with the local database and checks whether
	 * there are custom layout sections.
	 *
	 * @param array $arrFiles    An array of files
	 * @param array $arrDbFields An array of database fields
	 *
	 * @return string The form markup
	 */
...
<div class="tl_submit_container">
  <input type="submit" name="save" id="save" class="tl_submit" accesskey="s" value="'.specialchars($GLOBALS['TL_LANG']['MSC']['continue']).'">
	 ...
	 * Export a theme
	 *
	 * @param DataContainer $dc The data container object
	 */
	 ...
	 *
	 * @param ZipWriter $objArchive The archive object
