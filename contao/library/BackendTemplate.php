...
class BackendTemplate extends Template
{
	...
	public function output()
	{
		...
		{
			$this->stylesheets .= '<link rel="stylesheet" href="' . $this->addStaticUrlTo('assets/contao/css/debug.min.css') . '">' . "\n";
		}
	...
	/**
	 * Return the date picker string
	 *
	 * Fixes the MooTools more parsers which incorrectly parse ISO-8601 and do
	 * not handle German date formats at all.
	 *
	 * @return string The date picker string
	 */
