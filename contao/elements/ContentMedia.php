	...
	public function generate()
	{
		...
		if (TL_MODE == 'BE')
		{
			...
			while ($objFiles->next())
			{
				...
				$return .= '<li><img src="' . TL_ASSETS_URL . 'components/contao/images/' . $objFile->icon . '" width="18" height="18" alt="" class="mime_icon"> <span>' . $objFile->name . '</span> <span class="size">(' . $this->getReadableSize($objFile->size) . ')</span></li>';
			}
